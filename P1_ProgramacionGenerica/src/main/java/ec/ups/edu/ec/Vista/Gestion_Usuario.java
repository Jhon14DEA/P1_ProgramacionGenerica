...
public class Gestion_Usuario extends javax.swing.JFrame {
    ...
    ControladorUsuario ctlUsuario = new ControladorUsuario();
    ...
    public Gestion_Usuario() {
        ...
        tablaUsuario = (DefaultTableModel) tblGestionUsuario.getModel();
        
    }
    public void crearTabla(){
    
        tablaUsuario.setRowCount(0);
        for (Usuario usuario : ctlUsuario.getListado()){
            String []datos = {usuario.getCedula()};       
    ...
    private void initComponents() {
        ...
        jLabel5.setFont(new java.awt.Font("Agency FB", 2, 36)); // NOI18N
        jLabel5.setText("Gestion Telefonos.");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        // TODO add your handling code here:
        if(ctlUsuario.crearUsuario(txtCedula.getText(),txtNombre.getText(),txtApellido.getText(), txtEmail.getText(), txtContrasena.getText())){
